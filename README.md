...
# <span style="color: #52b788; font-style: italic; font-weight: 700; font-size: 1.8em;">Brevify</span>

<p style="font-size: 1.2em; color: #949393; margin-top: -10px;">
...
![Brevify Banner](assets/screenshots/banner-anim.gif)
_The summary banner seamlessly integrates at the top of any webpage_

### Expanded Summary

![Expanded Summary](assets/screenshots/webpage-ss.png)
_Click to expand and view the complete extractive summary_

### Extension Popup

![Extension Popup](assets/screenshots/popup-main.png)

_Clean, intuitive popup interface for quick access_

### Tweaks Menu

![Settings View](assets/screenshots/popup-settings.png)
